...
async function GetUsuario(usuario){
    ...
    if(Dadosperfil.login == undefined){
        ...
        perfil.innerHTML = ('<p class="user_name">Usuário: '+Dadosperfil.login+'</p><div class="row"><div class="col-md-4"><div class="card" style="width: 18rem;"><img src="'
                            +Dadosperfil.avatar_url+'" width="265" height="265" class="card-img-top"/><ul class="list_group list-group-flush"><li class="list-group-item"><span class="badge">'
                            +Dadosperfil.public_repos+'</span></li><li class="list-group-item"><span class="badge">'
                            +Dadosperfil.followers+'</span></li><li class="list-group-item"><span class="badge">'
                            +Dadosperfil.following+'</span></li></ul></div></div></div>')
    }    
}
